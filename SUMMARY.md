...
* [DSOM Governance Framework & Metacognitive Protocol](docs/explanation/dsom-governance.md)
* [Diátaxis Structuring Framework Implementation](docs/explanation/diataxis.md)
...
* [How to Produce a Project Technical Handbook: The AI Prompt Engineering & Skill Adoption Blueprint](docs/how-to/HOW-TO-PRODUCE-PROJECT-TECHNICAL-HANDBOOK.md)
...
* [How-To: Manage Inventory, Live Sessions, and Payouts](docs/how-to/manage-inventory-and-payouts.md)
* [Operational Recipes Index](docs/how-to/index.md)

## Reference

* [Component & Tool Technical Index](docs/reference/index.md)
* [OpenWiki Engine & Data Parsing Specification](docs/reference/openwiki-emulator.md)
* [Technical Reference: CLI, Tools & Utilities Specifications](docs/reference/cli-and-tools.md)
* [Technical Reference: File Structure, Architecture & Schema](docs/reference/file-structure-and-api.md)

## Tutorials

* [Quickstart Onboarding Guide](docs/tutorials/01-getting-started.md)
* [Tutorial: Getting Started with Omni-View](docs/tutorials/getting-started.md)
* [Tutorial: LLMs.txt & XML Context Setup Pipeline](docs/tutorials/llms-txt-setup.md)
...
* [SOP: Knowledge-First Discovery & Context Preservation Protocol](docs/SOP-KNOWLEDGE-FIRST-DISCOVERY.md)
