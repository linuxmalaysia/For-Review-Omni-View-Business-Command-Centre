...
Welcome to the documentation hub for **Omni-View Business Command Centre**.

This documentation system is governed by the **Deep State of Mind (DSOM) Protocol**, adopting the **Diátaxis Structuring Framework** and **Google Open Knowledge Format (OKF v0.2)** metadata standards.

---

## 🧭 Navigation Summary

Explore the four Diátaxis documentation quadrants:

- **[Tutorials](tutorials/getting-started.md)**: Hands-on onboarding guides for users and developers.
- **[How-To Guides](how-to/manage-inventory-and-payouts.md)**: Operational recipes and practical procedural instructions.
