...
* [Architectural Explanation & Diátaxis Adoption](explanation/architecture-and-diataxis.md)
* [Google OKF 0.2 & DSOM Integration Rationale](explanation/okf-02-and-diataxis.md)

## Tutorials
* [Quickstart: Onboarding Guide](tutorials/01-getting-started.md)
* [Getting Started with Omni-View](tutorials/getting-started.md)
* [LLMs.txt Setup & Context Pipeline](tutorials/llms-txt-setup.md)
...
* [File Structure, Architecture & Database Schema](reference/file-structure-and-api.md)
* [CLI Tools, Python Utilities & Specification](reference/cli-and-tools.md)
